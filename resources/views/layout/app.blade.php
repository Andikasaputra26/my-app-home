...
<head>
    ...
    <link rel="stylesheet" href="{{asset ('app/css/textanimation.css')}}">
    ...
    <div id="wrapper">
        <div id="pagee" class="clearfix">
            ...
            <main id="main">
                ...
                <section class="slider-home4 relative">
                    <div class="tf-container">
                        ...
                        <div class="mask-slider">
                            <img src="{{asset ('assets/images/slide/mask-home4.png')}}" alt="Image" class="mask-slider1">
                        </div>
                    </div>
                </section>
                <!-- Widget Slider -->
                            ...
                            <div class="col-md-12 col-lg-6">
                                <div class="image-about-h4-wrap relative">
                                    <div class="image-about-item relative about-wrap-left wow fadeInLeft animated "
                                        data-wow-delay="0.1s">
                                        <img src="{{asset('assets/images/about-us/about-h41.jpg')}}" alt="image">
                                        <img src="{{asset('assets/images/page/shape5.1.png')}}" alt="image" class="shape-about-h4">
                                    ...
                                    <div class="image-about-item relative about-wrap-right wow fadeInUp animated "
                                        data-wow-delay="0.1s">
                                        <img src="{{asset('assets/images/about-us/about-h4.jpg')}}" alt="image">
                                        <img src="{{asset('assets/images/page/shape5.1.png')}}" alt="image" class="shape-about-h4">
                            ...
                            <div class="col-md-12 col-lg-6 inner-content-about">
                                ...
                                <div class="flex-three btn-wrap-about  mb-30 ">
                                    ...
                                    <div class="profile flex-three wow fadeInUp animated">
                                        <div class="image">
                                            <img src="{{asset('assets/images/avata/10.jpg')}}" alt="">
                                        </div>
                                        <div class="content">
                                            <img src="{{asset('assets/images/page/name.png')}}" alt="">
                ...
                <!-- Widget destination -->
                <section class="widget-destination1 destination-home5 pd-main relative">
                    <img src="{{asset('assets/images/page/shape2.png')}}" alt="image" class="shape-destination">
                    <div class="tf-container">
                        <div class="row mb-50 relative z-index1">
                            <div class="col-md-9">
                                <div class="">
                                    <span
                                    ...
                                    <h2 class="title-heading wow fadeInUp animated">We Provide Top <span
                                            class="text-main font-yes">Destination</span></h2>
                                </div>
                            </div>
                            <div class="col-md-3 flex-six view-all-wrap">
                                <a href="tour-destination-v1.html" class="view-all wow fadeInUp animated">View all
                                    destination <i class="icon-Group-13"></i></a>
                            </div>
                        </div>
                        <div class="destination-grid relative z-index3">
                            <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.1s">
                                <a href="tour-destination-v1.html" class="destination-image">
                                    <img src="./assets/images/tour/tourh5.jpg" alt="">
                                </a>
                            ...
                            <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.2s">
                                <a href="tour-destination-v2.html" class="destination-image">
                                    <img src="{{asset('assets/images/tour/tour5.1.jpg')}}" alt="">
                                </a>
                                <div class="destination-tour-list">
                                    <div class="tour2">
                                        <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                            ...
                            <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.3s">
                                <a href="tour-destination-v3.html" class="destination-image">
                                    <img src="{{asset ('assets/images/tour/tour5.2.jpg') }}" alt="">
                                </a>
                                <div class="destination-tour-list">
                                    <div class="tour3">
                                        <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                            ...
                            <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.4s">
                                <a href="tour-destination-v1.html" class="destination-image">
                                    <img src="./assets/images/tour/tour5.3.jpg" alt="">
                                </a>
                                <div class="destination-tour-list">
                                    <div class="tour4">
                                        <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                                ...
                                <div class="title-tour"> <a href="tour-destination-v1.html">Swizerland</a></div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12 wow fadeInUp animated">
                                <p class="center destination-explore">Explore our top destinations voted by more than
                        ...
                        <div class="row">
                            <div class="col-md-5 mb-37">
                                <a href="single-destination.html" class="destination-style relative">
                                    ...
                                    <div class="destination-content">
                                        ...
                                        <p class="text-white">Switzerland</p>
                                    </div>
                                </a>
                            </div>
                            ...
                            <div class="col-md-3 mb-37">
                                <a href="single-destination.html" class="destination-style relative">
                                    ...
                                    <div class="destination-content">
                                        <div class="travel font-yes text-white">Travel to</div>
                                        <p class="text-white">Afghanistan</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-md-5 mb-37">
                                                        ...
                                                        <div class="icons flex-three">
                                                            <svg width="21" height="16" viewBox="0 0 21 16" fill="none"
                                                                ...
                                                                <path
                                                                    ...
                                                                    stroke="#DE3010" stroke-width="1.7"
                                                                    stroke-miterlimit="10" stroke-linecap="round"
                                                                    stroke-linejoin="round" />
                                                                <path
                                                                    ...
                                                                    stroke-miterlimit="10" stroke-linecap="round"
                                                                    stroke-linejoin="round" />
                                                                <path d="M17.1035 15.1797V9.02734" stroke="#DE3010"
                                                                    stroke-width="1.7" stroke-miterlimit="10"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                                <path d="M20.1797 12.1035H14.0273" stroke="#DE3010"
                                                                    stroke-width="1.7" stroke-miterlimit="10"
                                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                            </svg>
                                                            <span>12 Person</span>
